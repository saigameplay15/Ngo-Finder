	...
	<body>
		<div class="event-box">
			...
			<form action="EditEvent" method="POST" id="form">
        		<div class="textbox">
        	    	<input type="text" value=${ ename} id="EventName" required>
        		</div>

        		<div class="textbox">
            		<input type="text" value=${ desc} id="Description" required>
        		</div>

        		<div class="textbox">
            		<input type="text" value=${ loc} id="Location" required>
        		</div>

        		<div class="textbox">
            		<input type="text" value=${ sd} id="StartDate" required>
        		</div>

        		<div class="textbox">
            		<input type="text" value=${ ed} id="EndDate" required>
        		</div>

        		<div class="textbox">
            		<input type="text" value=${ st} id="StartTime" required>
        		</div>

	        	<div class="textbox">
    	        	<input type="text" value=${ et} id="EndTime" required>
        		</div>
